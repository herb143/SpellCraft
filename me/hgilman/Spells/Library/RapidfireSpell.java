...
public class RapidfireSpell extends Spell {
	...
	{
		super(instancePlayer,instance,false,"Rapidfire","Fires off a fast volley of arrows.",new ItemStack(Material.ARROW, 8), new ItemStack(Material.REDSTONE, 4)); // Call the super constructor.
	}
	...
	protected void castSpell()
	{
		...
		{
			plugin.getServer().getScheduler().scheduleSyncDelayedTask(plugin, new RapidfireRunnable(player),iii);
		}
	}
}